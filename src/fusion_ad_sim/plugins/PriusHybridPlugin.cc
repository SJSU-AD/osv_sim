...
void PriusHybridPlugin::OnPriusCommand(const osv_msgs::Control::ConstPtr &msg)
{
  ...
  {
    case osv_msgs::Control::NEUTRAL:
      this->dataPtr->directionState = PriusHybridPluginPrivate::NEUTRAL;
      break;
    case osv_msgs::Control::FORWARD:
      this->dataPtr->directionState = PriusHybridPluginPrivate::FORWARD;
      break;
    case osv_msgs::Control::REVERSE:
